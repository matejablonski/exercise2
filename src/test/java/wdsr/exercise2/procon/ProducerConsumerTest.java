...
public class ProducerConsumerTest {
  ...
  public void testBufferManualImpl() throws InterruptedException {
    ...
    assertEquals(OrderProducerModule.THREAD_COUNT * OrderProducerModule.ORDERS_PER_THREAD,
        consumedOrders.size());
  ...
  private class OrderProducerHelperTestImpl implements OrderProducerHelper {
    ...
    public Order nextOrder() {
      return new Order(counter.incrementAndGet(), "Gold", counter.get() * 10,
          new BigDecimal(counter.get() % 100));
    }
